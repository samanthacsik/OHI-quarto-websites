...
4. **Preview your site** by typing `quarto preview` in your RStudio Terminal. This will launch a preview of your website in a browser window. So long as you leave the preview running, it will update each time you make / save changes to website files (which makes iterating on your work really easy!). By default, your repo name will appear as both your navbar and landing page titles, alongside some other placeholder text. A second navbar page, titled "About", is created for you as well.
